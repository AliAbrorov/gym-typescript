        ...
        <motion.div onViewportEnter={()=>setSelectedPage(SelectedPage.ContactUs)}>
            ...
            variants={{
               ...
               <HText>
                ...
                <p className="my-5">
                Embark on a fitness journey with our diverse classes designed to cater to all levels. Whether you're a beginner or a seasoned enthusiast, our expert instructors and supportive community are here to help you achieve your fitness goals. Join us today to experience the joy of staying active, healthy, and in great shape.
                </p>
            </motion.div>
            ...
            <div className="mt-10 justify-between gap-8 md:flex">
                ...
                variants={{
                   ...
                   method="POST"
                   action="https://formsubmit.co/2e0be7c654209e0a82e817fb78e00818">
